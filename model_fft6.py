...
#	pool13 = MaxPooling1D(pool_size=2)(A3)
	...
	B1 = Conv1D(8, kernel_size=4, activation='relu', kernel_initializer='glorot_normal')(input2)
	pool21 = MaxPooling1D(pool_size=4)(B1)
	B2 = Conv1D(4, kernel_size=2, activation='relu', kernel_initializer='glorot_normal')(pool21)
...
#	pool23 = MaxPooling1D(pool_size=2)(B3)
	B4 = Conv1D(2, kernel_size=1, activation='relu', kernel_initializer='glorot_normal')(pool22)
