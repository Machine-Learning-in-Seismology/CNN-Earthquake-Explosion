...
def build_nn(input_shape1,input_shape2):
	...
	A3 = Conv1D(16, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool12)
	...
	B3 = Conv1D(2, kernel_size=1, activation='relu', kernel_initializer='glorot_normal')(pool23)
