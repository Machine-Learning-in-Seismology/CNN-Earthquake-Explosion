...
def build_nn(input_shape1,input_shape2):
	...
	A1 = Conv1D(32, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(input1)
	pool11 = MaxPooling1D(pool_size=2)(A1)
	A2 = Conv1D(16, kernel_size=3, activation='relu', kernel_initializer='glorot_normal')(pool11)
	pool12 = MaxPooling1D(pool_size=2)(A2)

	flattened_wf = Flatten()(pool12)  

	input2 = Input(shape=input_shape2,name='input2')
	B1 = Conv1D(16, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(input2)
	pool21 = MaxPooling1D(pool_size=2)(B1)
	B2 = Conv1D(8, kernel_size=3, activation='relu', kernel_initializer='glorot_normal')(pool21)
