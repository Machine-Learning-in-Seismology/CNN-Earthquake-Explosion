...
#	pool12 = MaxPooling1D(pool_size=2)(A2)
	A3 = Conv1D(32, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(input1)
...
#	pool22 = MaxPooling1D(pool_size=2)(B2)
	B3 = Conv1D(16, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(input2)
	pool23 = MaxPooling1D(pool_size=2)(B3)
	B4 = Conv1D(8, kernel_size=3, activation='relu', kernel_initializer='glorot_normal')(pool23)
