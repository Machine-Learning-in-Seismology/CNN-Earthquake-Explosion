...
def build_nn(input_shape1,input_shape2):
	...
	A1 = Conv1D(64, kernel_size=24, activation='relu', kernel_initializer='glorot_normal')(input1)
	pool11 = MaxPooling1D(pool_size=4)(A1)
	A2 = Conv1D(32, kernel_size=12, activation='relu', kernel_initializer='glorot_normal')(pool11)
	pool12 = MaxPooling1D(pool_size=2)(A2)
#	A3 = Conv1D(32, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool12)
#	pool13 = MaxPooling1D(pool_size=2)(A3)
	A4 = Conv1D(16, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool12)
	...
	B1 = Conv1D(64, kernel_size=24, activation='relu', kernel_initializer='glorot_normal')(input2)
	pool21 = MaxPooling1D(pool_size=4)(B1)
	B2 = Conv1D(32, kernel_size=12, activation='relu', kernel_initializer='glorot_normal')(pool21)
	pool22 = MaxPooling1D(pool_size=2)(B2)
#	B3 = Conv1D(32, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool22)
#	pool23 = MaxPooling1D(pool_size=2)(B3)
	B4 = Conv1D(16, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool22)
