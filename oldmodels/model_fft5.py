...
def build_nn(input_shape1,input_shape2):
	...
	A3 = Conv1D(32, kernel_size=12, activation='relu', kernel_initializer='glorot_normal')(pool12)
	pool13 = MaxPooling1D(pool_size=2)(A3)
	A4 = Conv1D(16, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool13)
