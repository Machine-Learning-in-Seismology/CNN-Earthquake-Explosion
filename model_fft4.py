...
#	pool12 = MaxPooling1D(pool_size=2)(A2)
	A3 = Conv1D(32, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool11)
...
#	pool22 = MaxPooling1D(pool_size=2)(B2)
	B3 = Conv1D(32, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool21)
