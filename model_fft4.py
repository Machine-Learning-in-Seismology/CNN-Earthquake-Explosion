...
#	pool22 = MaxPooling1D(pool_size=2)(B2)
	B3 = Conv1D(8, kernel_size=6, activation='relu', kernel_initializer='glorot_normal')(pool21)
	pool23 = MaxPooling1D(pool_size=2)(B3)
	B4 = Conv1D(2, kernel_size=3, activation='relu', kernel_initializer='glorot_normal')(pool23)
